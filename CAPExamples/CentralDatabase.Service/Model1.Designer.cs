...
namespace CentralDatabase.Service
{
    ...
    /// </summary>
    public partial class CAP_CentralDatabaseEntities : ObjectContext
    {
        #region Constructors
    
        /// <summary>
        /// Initializes a new CAP_CentralDatabaseEntities object using the connection string found in the 'CAP_CentralDatabaseEntities' section of the application configuration file.
        /// </summary>
        public CAP_CentralDatabaseEntities() : base("name=CAP_CentralDatabaseEntities", "CAP_CentralDatabaseEntities")
        {
        ...
        /// <summary>
        /// Initialize a new CAP_CentralDatabaseEntities object.
        /// </summary>
        public CAP_CentralDatabaseEntities(string connectionString) : base(connectionString, "CAP_CentralDatabaseEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
        ...
        /// Initialize a new CAP_CentralDatabaseEntities object.
        /// </summary>
        public CAP_CentralDatabaseEntities(EntityConnection connection) : base(connection, "CAP_CentralDatabaseEntities")
        {
            this.ContextOptions.LazyLoadingEnabled = true;
            OnContextCreated();
        }
    ...
    /// No Metadata Documentation available.
    /// </summary>
    [EdmEntityTypeAttribute(NamespaceName="CAP_CentralDatabaseModel", Name="AccountBalance")]
    [Serializable()]
